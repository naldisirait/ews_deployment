...
def to_tensor(input_data, framework="pytorch"):
    ...
    Args:
        input_data: The input, which can be a NumPy array, PyTorch tensor, or TensorFlow tensor.
        framework: Specify the framework: "pytorch" or "tensorflow".
    ...
    datas = torch.tensor(input_data, dtype= torch.float32)
    return datas
